...
// First returns the first Address entity in the query. Returns *NotFoundError when no address was found.
...
// FirstID returns the first Address id in the query. Returns *NotFoundError when no id was found.
...
func (aq *AddressQuery) FirstXID(ctx context.Context) int {
...
// Only returns the only Address entity in the query, returns an error if not exactly one entity was returned.
...
// OnlyID returns the only Address id in the query, returns an error if not exactly one id was returned.
...
func (aq *AddressQuery) Select(field string, fields ...string) *AddressSelect {
	selector := &AddressSelect{config: aq.config}
...
func (aq *AddressQuery) sqlQuery() *sql.Selector {
...
// AddressGroupBy is the builder for group-by Address entities.
...
// AddressSelect is the builder for select fields of Address entities.
