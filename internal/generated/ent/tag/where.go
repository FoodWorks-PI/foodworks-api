...
func HasProductWith(preds ...predicate.Product) predicate.Tag {
	return predicate.Tag(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasRestaurant() predicate.Tag {
	return predicate.Tag(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(RestaurantTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2M, true, RestaurantTable, RestaurantPrimaryKey...),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}
...
func HasRestaurantWith(preds ...predicate.Restaurant) predicate.Tag {
	return predicate.Tag(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasImagesWith(preds ...predicate.ImagePath) predicate.Tag {
	return predicate.Tag(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
